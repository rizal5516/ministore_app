...
import 'package:ministore_app/consts/api_consts.dart';
import 'package:ministore_app/models/categories_model.dart';
import 'package:ministore_app/models/products_model.dart';
import 'package:ministore_app/models/users_model.dart';
...
class APIHandler {
  ...
  static Future<ProductsModel> getUsersById({required String id}) async {
    try {
      var uri = Uri.https(
        BASE_URL,
        "api/v1/users/$id",
